(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $(".cls_nav_wrapper ul li").hover(function () {
            if ($(window).width() < 700) {
                return;
            }
        ...
        $(".header_style4 .cls_nav_wrapper ul li").hover(function () {
            if ($(window).width() < 700) {
                return;
            }
            var subMenu = $(".header_style4 .cls_nav_wrapper ul").find(".mega-menu-wrapper");

            var subMenu123 = $(".header_style4 .cls_nav_wrapper ul").find("li.mega-menu");
        ...
        $(".header_style6 .cls_nav_wrapper ul li").hover(function () {
            if ($(window).width() < 700) {
                return;
            }
            var subMenu = $(".header_style6 .cls_nav_wrapper ul").find(".mega-menu-wrapper");
            var subMenu123 = $(".header_style6 .cls_nav_wrapper ul").find("li.mega-menu");
        ...
        $(".header_style7 .cls_nav_wrapper ul li").hover(function () {
            if ($(window).width() < 700) {
                return;
            }
            var subMenu = $(".header_style7 .cls_nav_wrapper ul").find(".mega-menu-wrapper");
            var subMenu123 = $(".header_style7 .cls_nav_wrapper ul").find("li.mega-menu");
