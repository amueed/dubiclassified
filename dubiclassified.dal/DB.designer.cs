...
namespace dubiclassified.dal
{
    ...
    partial void Deleteweb_config(web_config instance);
		...
		public DBDataContext() : 
				base(global::dubiclassified.dal.Properties.Settings.Default.dubizzleConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class ad : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ads_img> _ads_imgs;
    ...
    partial void OnapprovedChanged();
		...
		public ad()
		{
			this._ads_imgs = new EntitySet<ads_img>(new Action<ads_img>(this.attach_ads_imgs), new Action<ads_img>(this.detach_ads_imgs));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ad_ads_img", Storage="_ads_imgs", ThisKey="ad_id", OtherKey="ad_id")]
		public EntitySet<ads_img> ads_imgs
		{
			get
			{
				return this._ads_imgs;
			}
			set
			{
				this._ads_imgs.Assign(value);
			}
		}
		...
		private void attach_ads_imgs(ads_img entity)
		{
			this.SendPropertyChanging();
			entity.ad = this;
		}
		
		private void detach_ads_imgs(ads_img entity)
		{
			this.SendPropertyChanging();
			entity.ad = null;
		}
    ...
    partial void OndeletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ad_ads_img", Storage="_ad", ThisKey="ad_id", OtherKey="ad_id", IsForeignKey=true)]
		public ad ad
		{
			get
			{
			...
			set
			{
							...
							|| (this._ad.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ads_imgs.Remove(this);
					}
					this._ad.Entity = value;
					if ((value != null))
					{
						value.ads_imgs.Add(this);
						this._ad_id = value.ad_id;
					}
					else
					{
						this._ad_id = default(long);
					}
